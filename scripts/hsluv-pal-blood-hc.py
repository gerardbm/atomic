...
# Output the values
with open('../xresources/Xresources.blood_hc', 'w') as f:
    sys.stdout = f
    print("! Atomic Blood HC")
    print("#define base1", HEX01)
    print("#define base2", HEX02)
    print("#define base3", HEX03)
    print("#define base4", HEX04)
...
with open('../xresources/Xresources.URxvtSwitch', 'a+') as f:
    ...
    print("")
    print("! Blood HC")
    print(f"URxvt.keysym.C-F4: command:\\033]10;{HEX04}\\007\\033]11;{HEX01}\\007\\")
...
# Output the values
with open('../values/atomic-blood-hc.md', 'w') as f:
    sys.stdout = f
    print("# Atomic Blood High Contrast")
    print("")
    print("```")
