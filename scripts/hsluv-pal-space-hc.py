...
# Output the values
with open('../xresources/Xresources.space_hc', 'w') as f:
    sys.stdout = f
    print("! Atomic Space HC")
    print("#define base1", HEX01)
    print("#define base2", HEX02)
    print("#define base3", HEX03)
    print("#define base4", HEX04)
...
# Output the values
with open('../values/atomic-space-hc.md', 'w') as f:
    sys.stdout = f
    print("# Atomic Space High Contrast")
    print("")
    print("```")
