...
# Output the values
with open('../xresources/Xresources.night_lc', 'w') as f:
    sys.stdout = f
    print("! Atomic Night LC")
    print("#define base1", HEX01)
    print("#define base2", HEX02)
    print("#define base3", HEX03)
    print("#define base4", HEX04)
...
with open('../xresources/Xresources.URxvtSwitch', 'a+') as f:
    ...
    print("")
    print("! Night LC")
    print(f"URxvt.keysym.C-6: command:\\033]10;{HEX04}\\007\\033]11;{HEX01}\\007\\")
...
# Output the values
with open('../values/atomic-night-lc.md', 'w') as f:
    sys.stdout = f
    print("# Atomic Night Low Contrast")
    print("")
    print("```")
