...
H01 = BA  ; S01 = 21 ; L01 = 3  ; BASE1 = [] ; ZASE1 = [] #base1
H02 = BA  ; S02 = 21 ; L02 = 6  ; BASE2 = [] ; ZASE2 = [] #base2
...
# Output the values
with open('../xresources/Xresources.ocean_hc', 'w') as f:
    sys.stdout = f
    print("! Atomic Ocean HC")
    print("#define base1", HEX01)
    print("#define base2", HEX02)
    print("#define base3", HEX03)
    print("#define base4", HEX04)
...
with open('../xresources/Xresources.URxvtSwitch', 'a+') as f:
    ...
    print("")
    print("! Ocean HC")
    print(f"URxvt.keysym.C-F10: command:\\033]10;{HEX04}\\007\\033]11;{HEX01}\\007\\")
...
# Output the values
with open('../values/atomic-ocean-hc.md', 'w') as f:
    sys.stdout = f
    print("# Atomic Ocean High Contrast")
    print("")
    print("```")
