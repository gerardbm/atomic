...
H01 = BA  ; S01 = 34 ; L01 = 91 ; BASE1 = [] ; ZASE1 = [] #base1
H02 = BA  ; S02 = 34 ; L02 = 88 ; BASE2 = [] ; ZASE2 = [] #base2
...
# Output the values
with open('../xresources/Xresources.light_lc', 'w') as f:
    sys.stdout = f
    print("! Atomic Light LC")
    print("#define base1", HEX01)
    print("#define base2", HEX02)
...
# Output the values
with open('../values/atomic-light-lc.md', 'w') as f:
    sys.stdout = f
    print("# Atomic Light Low Contrast")
    print("")
    print("```")
