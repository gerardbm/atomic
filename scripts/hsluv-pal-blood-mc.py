...
# Output the values
with open('../xresources/Xresources.blood_mc', 'w') as f:
    sys.stdout = f
    print("! Atomic Blood MC")
    print("#define base1", HEX01)
    print("#define base2", HEX02)
    print("#define base3", HEX03)
    print("#define base4", HEX04)
...
with open('../xresources/Xresources.URxvtSwitch', 'a+') as f:
    ...
    print("")
    print("! Blood MC")
    print(f"URxvt.keysym.C-F5: command:\\033]10;{HEX04}\\007\\033]11;{HEX01}\\007\\")
...
# Output the values
with open('../values/atomic-blood-mc.md', 'w') as f:
    sys.stdout = f
    print("# Atomic Blood Medium Contrast")
    print("")
    print("```")
